...
export const SignUpView = () => {
  ...
  return (
    <div className="flex flex-col gap-6">
      <Card className="oveflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 md:p-8">
              <div className="flex flex-col gap-6">
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            type="email"
                            placeholder="youcool@digital.summit"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                ...
                <div className="text-center text-sm">
                  ...
                  <Link
                    href="/sign-in"
                    className="underline unbderline-offset-4"
                  >
                    Sign In
                  </Link>
                </div>
          ...
          <div className="bg-radial from-[#335edd] to-[#2f2da2] relative hidden md:flex flex-col gap-y-4 items-center justify-center">
            <Image
              ...
              height={1024}
            />
            <p className="text-2xl font-semibold text-white">Prodius.AI</p>
          </div>
        </CardContent>
      </Card>
